<!-- SIDEBAR FIXLY -->
<aside class="w-64 bg-[#1e293b] text-white flex flex-col justify-between shrink-0 shadow-lg min-h-screen">
    <div>
        <!-- Logo & Brand Fixly dari Public Images -->
        <div class="p-6 flex flex-col items-center border-b border-slate-700/50">
        ...
        <!-- Navigation Links (Berdasarkan Role User) -->
        <nav class="mt-6 px-4 space-y-5 text-sm">
            @auth
                @php
