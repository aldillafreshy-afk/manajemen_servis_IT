            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('perangkat.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="kode_perangkat" value="{{ old('kode_perangkat') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_perangkat" value="{{ old('nama_perangkat') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="jenis_perangkat" value="{{ old('jenis_perangkat') }}" placeholder="Contoh: PC Desktop, Printer, Router" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="merk" value="{{ old('merk') }}" placeholder="Contoh: ASUS, Epson, TP-Link" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="tahun_pembelian" value="{{ old('tahun_pembelian') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
